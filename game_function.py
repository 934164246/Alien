...
def check_events(ai_settings, screen, stats, sb, play_button, ship, aliens, bullets, star):
    """响应按键和鼠标事件"""
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            # 游戏终止前将最高分存入文件中(更新前先清空文件中的内容)
            ...
            check_play_button(ai_settings, screen, stats, sb, play_button,
                              ship, aliens, bullets, mouse_x, mouse_y, star)


def check_play_button(ai_settings, screen, stats, sb, play_button, ship, aliens,
                      bullets, mouse_x, mouse_y, star):
    """玩家在单击Play的时候开始游戏"""
